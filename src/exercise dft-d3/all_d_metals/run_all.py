#!/usr/bin/env python3
"""
parallel_hardcoded.py

Hardcoded batch pipeline:
- All d-block transition metals
- Both oxides and sulfides (O and S)
- Parallel: metal×ligand tasks in parallel; strains per POSCAR in parallel
